      ...
      <div className="max-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          <a href="https://prebuiltui.com">
            <img src="/logo_updated.svg" alt="logo" className="h-11 w-auto" />
          </a>

          <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-50">
          ...
          <div className="flex gap-2">
            <a
              href=""
              className="hidden md:block px-6 py-2 bg-indigo-600 hover:bg-indigo-700 active:scale-95 transition-all rounded-full text-white"
            >
              Get started
            </a>
            <a
              href=""
              className="hidden md:block px-6 py-2 border active:scale-95 hover:bg-slate-50 transition-all rounded-full text-slate-300 hover:text-slate-900"
            >
              Login
            </a>
          </div>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          <div className="flex items-center mt-24">
            ...
            <div>
              ...
              <p className="text-sm text-slate-50">Used by 10,000+ users</p>
            </div>
          </div>

          {/* Headline + CTA */}
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px] text-slate-50">
            Build stunning websites with{" "}
            <span className=" bg-gradient-to-r from-indigo-700 to-indigo-400 bg-clip-text text-transparent text-nowrap">
              ready-to-use{" "}
            </span>{" "}
            templates.
          </h1>
          ...
          <p className="max-w-md text-center text-base my-7 text-gray-400">
            Explore a growing library of career-ready templates and smart
            sections to build your resume faster.
          </p>
          ...
          <div className="flex items-center gap-4 ">
            <a
              href="/"
              className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-full px-9 h-12 m-1 flex items-center transition-colors"
              //   ring-offset-2 ring-1 ring-indigo-400
            >
              Get started
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {/* <p className="py-6 text-gray-400 mt-14">
